  ...
  return (
    <div className="grid gap-4">
      <div className="flex items-center justify-between">
        <h2 className="page-title">אירועים</h2>
      ...
      <div className="grid gap-3">
        {events.map((event) => (
          <Link key={event.id} href={`/admin/events/${event.id}`} className="card card-interactive flex items-center justify-between gap-3 p-4">
